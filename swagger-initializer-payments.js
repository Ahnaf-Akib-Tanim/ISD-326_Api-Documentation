  ...
  window.ui = SwaggerUIBundle({
    spec: {
      ...
      paths: {
        ...
        "/hosts/{hostId}/transactions": {
          get: {
            tags: ["Financial Management"],
            summary: "Get detailed transaction history for a host",
            parameters: [
              { name: "hostId", in: "path", required: true, schema: { type: "string" }, example: "host123" },
              { name: "type", in: "query", required: false, schema: { type: "string", enum: ["earning", "payout", "refund", "fee"] }, example: "earning" },
              { name: "start", in: "query", required: false, schema: { type: "string", format: "date" }, example: "2026-03-01" },
              { name: "end", in: "query", required: false, schema: { type: "string", format: "date" }, example: "2026-03-31" }
            ],
            responses: {
              "200": {
                ...
                content: {
                  "application/json": {
                    ...
                    examples: {
                      marchTransactions: {
                        summary: "GET /hosts/host123/transactions?start=2026-03-01&end=2026-03-31",
                        value: {
                          hostId: "host123",
                          transactions: [
                            { transactionId: "txn_001", type: "earning", amount: 350.00, currency: "USD", bookingId: "booking101", description: "Booking payment received", date: "2026-03-01" },
                            { transactionId: "txn_002", type: "fee", amount: -35.00, currency: "USD", bookingId: "booking101", description: "Platform service fee (10%)", date: "2026-03-01" },
                            { transactionId: "txn_003", type: "payout", amount: -315.00, currency: "USD", bookingId: null, description: "Bank transfer payout", date: "2026-03-05" },
                            { transactionId: "txn_004", type: "refund", amount: -175.00, currency: "USD", bookingId: "booking102", description: "Partial refund issued to guest", date: "2026-03-08" }
                          ],
                          totalCount: 4
                        }
                      }
        ...
        "/hosts/{hostId}/tax-summary": {
          get: {
            tags: ["Financial Management"],
            summary: "Get tax summary report for a host",
            parameters: [
              { name: "hostId", in: "path", required: true, schema: { type: "string" }, example: "host123" },
              ...
              "200": {
                ...
                content: {
                  "application/json": {
                    ...
                    examples: {
                      taxReport: {
                        summary: "GET /hosts/host123/tax-summary?year=2026",
                        value: {
                          hostId: "host123",
                          year: 2026,
                          grossIncome: 4800.00,
